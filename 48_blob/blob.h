...
extern unsigned int copy_to_buffer (const struct blob * b, char * buf, unsigned int maxlen);
extern unsigned int copy_to_buffer_reverse (const struct blob * b, char * buf, unsigned int maxlen);
